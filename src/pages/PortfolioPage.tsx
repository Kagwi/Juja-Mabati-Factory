  ...
  const videos = [
    {
      ...
      videoUrl: 'https://raw.githubusercontent.com/Kagwi/Juja-Mabati-Factory/main/public/Corrugated%20Sheets.mp4', // In a real app, this would be the actual video URL
